...
5. После успешного старта контейнеров в директории auth/tests создать суперюзера. Для тестов рекомендуется создавать пользователя с именем 'admin', pass '1234' - именно такие данные установлены в тестовом конфиге.
```python
