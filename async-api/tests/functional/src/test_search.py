...
@pytest.mark.parametrize(
    'query_data, expected_answer', films_search
)
...
@pytest.mark.parametrize(
    'query_data, expected_answer', cache_search_films
)
...
@pytest.mark.parametrize(
    "query_data, expected_answer", persons_search
)
...
@pytest.mark.parametrize(
    'query_data, expected_answer', cache_search_persons
)
